...
public class DataProvider {
    ...
    public ArrayList<Glumac> getActors() {
        return actors;
    }
    ...
    private ArrayList<Glumac> actors;
    ...
    /**
     * Generisani builderi znatno pojednostavljuju kod za ovu metodu.
     */
    public void seedActors() {
        actors.add(new GlumacBuilder().setIme("Stan")
                .setPrezime("Lee")
        ...
        actors.add(new GlumacBuilder().setIme("Anthony")
                .setPrezime("Hopkins")
        ...
        actors.add(new GlumacBuilder().setIme("Quentin")
        ...
        actors.add(new GlumacBuilder().setIme("Leslie")
                .setPrezime("Nielsen")
                .setGodinaRodjenja(1926)
                .setGodinaSmrti(2010)
        ...
        actors.add(new GlumacBuilder().setIme("Uma")
                .setPrezime("Thurman")
                .setSpol(Glumac.Spol.ZENSKI)
